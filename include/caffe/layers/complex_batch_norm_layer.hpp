#ifndef CAFFE_COMPLEX_BATCHNORM_LAYER_HPP_
#define CAFFE_COMPLEX_BATCHNORM_LAYER_HPP_
...
class ComplexBatchNormLayer : public ComplexLayer<Dtype> {
 public:
  explicit ComplexBatchNormLayer(const LayerParameter& param)
...
#endif  // CAFFE_COMPLEX_BATCHNORM_LAYER_HPP_
